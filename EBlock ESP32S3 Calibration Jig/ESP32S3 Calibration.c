...
//**  Date:          Friday, August 21, 2026 12:19:50
//**  Users:         1
...
#define FCA_BUTTONSETCENTER 0xfa1e
#define FCV_BUTTONSETCENTER 0x2593
#define FCA_BUTTONASSIGNCENTER 0xfa1d
#define FCV_BUTTONASSIGNCENTER 0x257d
#define FCA_BUTTONMINUS50 0xfa1c
#define FCV_BUTTONMINUS50 0x251d
#define FCA_BUTTONPLUS50 0xfa1b
#define FCV_BUTTONPLUS50 0x252b
#define FCA_BUTTONMINUS1 0xfa1a
#define FCV_BUTTONMINUS1 0x2539
#define FCA_BUTTONPLUS1 0xfa19
#define FCV_BUTTONPLUS1 0x2547
#define FCA_BUTTONMINUS10 0xfa18
#define FCV_BUTTONMINUS10 0x2555
#define FCA_BUTTONPLUS10 0xfa17
#define FCV_BUTTONPLUS10 0x2563
#define FCA_BUTTONHOME2 0xfa16
#define FCV_BUTTONHOME2 0x250f
#define FCA_BUTTONASSIGN9 0xfa15
#define FCV_BUTTONASSIGN9 0x24e7
#define FCA_BUTTONASSIGN8 0xfa14
#define FCV_BUTTONASSIGN8 0x24d7
#define FCA_BUTTONASSIGN7 0xfa13
#define FCV_BUTTONASSIGN7 0x24b3
#define FCA_BUTTONSETID 0xfa12
#define FCV_BUTTONSETID 0x2479
#define FCA_BUTTONHOME1 0xfa11
#define FCV_BUTTONHOME1 0x243f
#define FCA_BUTTONASSIGN6 0xfa10
#define FCV_BUTTONASSIGN6 0x23d9
#define FCA_BUTTONASSIGN5 0x5faf
#define FCV_BUTTONASSIGN5 0x23e7
#define FCA_BUTTONASSIGN4 0x5fae
#define FCV_BUTTONASSIGN4 0x23f5
#define FCA_BUTTONASSIGN3 0x5fad
#define FCV_BUTTONASSIGN3 0x2403
#define FCA_BUTTONASSIGN2 0x5fac
#define FCV_BUTTONASSIGN2 0x2411
#define FCA_BUTTONASSIGN1 0x5fab
#define FCV_BUTTONASSIGN1 0x241f
#define FCA_BUTTONZEROALL 0x5faa
#define FCV_BUTTONZEROALL 0x22df
#define FCA_BUTTONID6 0x5fa9
#define FCV_BUTTONID6 0x22d1
...
/*=----------------------------------------------------------------------=*\
   Use :Changes the theme index of the selected Object or Widget.
       ...
       :  Redraw : MX_BOOL
\*=----------------------------------------------------------------------=*/
void FCD_05fa9_ButtonID6__ModifyColour(MX_UINT8 FCL_INDEX, MX_UINT8 FCL_R, MX_UINT8 FCL_G, MX_UINT8 FCL_B, MX_BOOL FCL_REDRAW)
{

  FCD_0a401_DisplayManager1__ModifyColour(32, FCL_INDEX, FCL_R, FCL_G, FCL_B, FCL_REDRAW);
...
/*=----------------------------------------------------------------------=*\
   Use :Returns the assigned object/widget ID.
       ...
       :Returns : MX_UINT16
\*=----------------------------------------------------------------------=*/
MX_UINT16 FCD_05fa9_ButtonID6__GetID()
{
...
/*=----------------------------------------------------------------------=*\
   Use :Changes the width and height of the selected Object or Widget.
       ...
       :  Height : MX_UINT16
\*=----------------------------------------------------------------------=*/
void FCD_05fa9_ButtonID6__ModifyScale(MX_UINT16 FCL_WIDTH, MX_UINT16 FCL_HEIGHT)
{

  FCD_0a401_DisplayManager1__ModifyScale(32, FCL_WIDTH, FCL_HEIGHT);
...
\*=----------------------------------------------------------------------=*/
void FCD_05fa9_ButtonID6__SetTextFloat(MX_FLOAT FCL_NUMBER, MX_UINT8 FCL_NUMDP, MX_CHAR *FCL_UNIT, MX_UINT16 FCLsz_UNIT)
{
  //Local variable definitions
  ...
  FCD_0a401_DisplayManager1__SetTextLabel(32, FCL_TEXT, FCLsz_TEXT, 0, 1, 1, 1);
...
\*=----------------------------------------------------------------------=*/
void FCD_05fa9_ButtonID6__SetTextLabel(MX_CHAR *FCL_TEXT, MX_UINT16 FCLsz_TEXT)
{
...
\*=----------------------------------------------------------------------=*/
void FCD_05fa9_ButtonID6__SetTextNumber(MX_SINT16 FCL_NUMBER, MX_CHAR *FCL_UNIT, MX_UINT16 FCLsz_UNIT)
{
  //Local variable definitions
  #define FCLsz_TEXT 20
  MX_CHAR FCL_TEXT[FCLsz_TEXT] = "";
...
\*=----------------------------------------------------------------------=*/
void FCD_05fa9_ButtonID6__ModifyPosition(MX_SINT16 FCL_X, MX_SINT16 FCL_Y, MX_BOOL FCL_RELATIVE)
{

  FCD_0a401_DisplayManager1__ModifyPosition(32, FCL_X, FCL_Y, FCL_RELATIVE);

}

#define FCA_BUTTONID5 0x5fa8
#define FCV_BUTTONID5 0x22c3
...
/*=----------------------------------------------------------------------=*\
   Use :Changes the theme index of the selected Object or Widget.
       ...
       :  Redraw : MX_BOOL
\*=----------------------------------------------------------------------=*/
void FCD_05fa8_ButtonID5__ModifyColour(MX_UINT8 FCL_INDEX, MX_UINT8 FCL_R, MX_UINT8 FCL_G, MX_UINT8 FCL_B, MX_BOOL FCL_REDRAW)
{

  FCD_0a401_DisplayManager1__ModifyColour(31, FCL_INDEX, FCL_R, FCL_G, FCL_B, FCL_REDRAW);
...
/*=----------------------------------------------------------------------=*\
   Use :Returns the assigned object/widget ID.
       ...
       :Returns : MX_UINT16
\*=----------------------------------------------------------------------=*/
MX_UINT16 FCD_05fa8_ButtonID5__GetID()
{
  //Local variable definitions
  MX_UINT16 FCR_RETVAL;
...
/*=----------------------------------------------------------------------=*\
   Use :Changes the width and height of the selected Object or Widget.
       ...
       :  Height : MX_UINT16
\*=----------------------------------------------------------------------=*/
void FCD_05fa8_ButtonID5__ModifyScale(MX_UINT16 FCL_WIDTH, MX_UINT16 FCL_HEIGHT)
{

  FCD_0a401_DisplayManager1__ModifyScale(31, FCL_WIDTH, FCL_HEIGHT);
...
/*=----------------------------------------------------------------------=*\
   Use :Draws a floating point value with optional units onto an object or Widget location.
       ...
       :  Unit[20] : Optional unit string to add after the numeric value. e.g. "g" or "s"
\*=----------------------------------------------------------------------=*/
void FCD_05fa8_ButtonID5__SetTextFloat(MX_FLOAT FCL_NUMBER, MX_UINT8 FCL_NUMDP, MX_CHAR *FCL_UNIT, MX_UINT16 FCLsz_UNIT)
{
  //Local variable definitions
  #define FCLsz_TEXT 20
  MX_CHAR FCL_TEXT[FCLsz_TEXT] = "";
  ...
  FCD_0a401_DisplayManager1__SetTextLabel(31, FCL_TEXT, FCLsz_TEXT, 0, 1, 1, 1);
...
/*=----------------------------------------------------------------------=*\
   Use :Draws a string onto an object or Widget location.
       ...
       :  Text[20] : Text string to set as the label
\*=----------------------------------------------------------------------=*/
void FCD_05fa8_ButtonID5__SetTextLabel(MX_CHAR *FCL_TEXT, MX_UINT16 FCLsz_TEXT)
{
...
/*=----------------------------------------------------------------------=*\
   Use :Draws an integer numerical value with optional units onto an object or Widget location.
       ...
       :  Unit[20] : Unit string to add after the numeric value. e.g. "g" or "s"
\*=----------------------------------------------------------------------=*/
void FCD_05fa8_ButtonID5__SetTextNumber(MX_SINT16 FCL_NUMBER, MX_CHAR *FCL_UNIT, MX_UINT16 FCLsz_UNIT)
{
  //Local variable definitions
  #define FCLsz_TEXT 20
  MX_CHAR FCL_TEXT[FCLsz_TEXT] = "";
...
/*=----------------------------------------------------------------------=*\
   Use :Moves an existing object or Widget to absolute coordinates on the screen.
       ...
       :  Relative : 0=Absolute Positioning, 1=Relative Positioning
\*=----------------------------------------------------------------------=*/
void FCD_05fa8_ButtonID5__ModifyPosition(MX_SINT16 FCL_X, MX_SINT16 FCL_Y, MX_BOOL FCL_RELATIVE)
{

  FCD_0a401_DisplayManager1__ModifyPosition(31, FCL_X, FCL_Y, FCL_RELATIVE);

}

#define FCA_BUTTONID4 0x5fa7
#define FCV_BUTTONID4 0x22b5
...
/*=----------------------------------------------------------------------=*\
   Use :Changes the theme index of the selected Object or Widget.
       ...
       :  Redraw : MX_BOOL
\*=----------------------------------------------------------------------=*/
void FCD_05fa7_ButtonID4__ModifyColour(MX_UINT8 FCL_INDEX, MX_UINT8 FCL_R, MX_UINT8 FCL_G, MX_UINT8 FCL_B, MX_BOOL FCL_REDRAW)
{

  FCD_0a401_DisplayManager1__ModifyColour(30, FCL_INDEX, FCL_R, FCL_G, FCL_B, FCL_REDRAW);
...
/*=----------------------------------------------------------------------=*\
   Use :Returns the assigned object/widget ID.
       ...
       :Returns : MX_UINT16
\*=----------------------------------------------------------------------=*/
MX_UINT16 FCD_05fa7_ButtonID4__GetID()
{
  //Local variable definitions
  MX_UINT16 FCR_RETVAL;
...
/*=----------------------------------------------------------------------=*\
   Use :Changes the width and height of the selected Object or Widget.
       ...
       :  Height : MX_UINT16
\*=----------------------------------------------------------------------=*/
void FCD_05fa7_ButtonID4__ModifyScale(MX_UINT16 FCL_WIDTH, MX_UINT16 FCL_HEIGHT)
{

  FCD_0a401_DisplayManager1__ModifyScale(30, FCL_WIDTH, FCL_HEIGHT);
...
/*=----------------------------------------------------------------------=*\
   Use :Draws a floating point value with optional units onto an object or Widget location.
       ...
       :  Unit[20] : Optional unit string to add after the numeric value. e.g. "g" or "s"
\*=----------------------------------------------------------------------=*/
void FCD_05fa7_ButtonID4__SetTextFloat(MX_FLOAT FCL_NUMBER, MX_UINT8 FCL_NUMDP, MX_CHAR *FCL_UNIT, MX_UINT16 FCLsz_UNIT)
{
  //Local variable definitions
  #define FCLsz_TEXT 20
  MX_CHAR FCL_TEXT[FCLsz_TEXT] = "";
  ...
  FCD_0a401_DisplayManager1__SetTextLabel(30, FCL_TEXT, FCLsz_TEXT, 0, 1, 1, 1);
...
/*=----------------------------------------------------------------------=*\
   Use :Draws a string onto an object or Widget location.
       ...
       :  Text[20] : Text string to set as the label
\*=----------------------------------------------------------------------=*/
void FCD_05fa7_ButtonID4__SetTextLabel(MX_CHAR *FCL_TEXT, MX_UINT16 FCLsz_TEXT)
{
...
/*=----------------------------------------------------------------------=*\
   Use :Draws an integer numerical value with optional units onto an object or Widget location.
       ...
       :  Unit[20] : Unit string to add after the numeric value. e.g. "g" or "s"
\*=----------------------------------------------------------------------=*/
void FCD_05fa7_ButtonID4__SetTextNumber(MX_SINT16 FCL_NUMBER, MX_CHAR *FCL_UNIT, MX_UINT16 FCLsz_UNIT)
{
  //Local variable definitions
  #define FCLsz_TEXT 20
  MX_CHAR FCL_TEXT[FCLsz_TEXT] = "";
...
/*=----------------------------------------------------------------------=*\
   Use :Moves an existing object or Widget to absolute coordinates on the screen.
       ...
       :  Relative : 0=Absolute Positioning, 1=Relative Positioning
\*=----------------------------------------------------------------------=*/
void FCD_05fa7_ButtonID4__ModifyPosition(MX_SINT16 FCL_X, MX_SINT16 FCL_Y, MX_BOOL FCL_RELATIVE)
{

  FCD_0a401_DisplayManager1__ModifyPosition(30, FCL_X, FCL_Y, FCL_RELATIVE);

}

#define FCA_BUTTONID3 0x5fa6
#define FCV_BUTTONID3 0x22a7
...
/*=----------------------------------------------------------------------=*\
   Use :Changes the theme index of the selected Object or Widget.
       ...
       :  Redraw : MX_BOOL
\*=----------------------------------------------------------------------=*/
void FCD_05fa6_ButtonID3__ModifyColour(MX_UINT8 FCL_INDEX, MX_UINT8 FCL_R, MX_UINT8 FCL_G, MX_UINT8 FCL_B, MX_BOOL FCL_REDRAW)
{

  FCD_0a401_DisplayManager1__ModifyColour(29, FCL_INDEX, FCL_R, FCL_G, FCL_B, FCL_REDRAW);
...
/*=----------------------------------------------------------------------=*\
   Use :Returns the assigned object/widget ID.
       ...
       :Returns : MX_UINT16
\*=----------------------------------------------------------------------=*/
MX_UINT16 FCD_05fa6_ButtonID3__GetID()
{
  //Local variable definitions
  MX_UINT16 FCR_RETVAL;
...
/*=----------------------------------------------------------------------=*\
   Use :Changes the width and height of the selected Object or Widget.
       ...
       :  Height : MX_UINT16
\*=----------------------------------------------------------------------=*/
void FCD_05fa6_ButtonID3__ModifyScale(MX_UINT16 FCL_WIDTH, MX_UINT16 FCL_HEIGHT)
{

  FCD_0a401_DisplayManager1__ModifyScale(29, FCL_WIDTH, FCL_HEIGHT);
...
/*=----------------------------------------------------------------------=*\
   Use :Draws a floating point value with optional units onto an object or Widget location.
       ...
       :  Unit[20] : Optional unit string to add after the numeric value. e.g. "g" or "s"
\*=----------------------------------------------------------------------=*/
void FCD_05fa6_ButtonID3__SetTextFloat(MX_FLOAT FCL_NUMBER, MX_UINT8 FCL_NUMDP, MX_CHAR *FCL_UNIT, MX_UINT16 FCLsz_UNIT)
{
  //Local variable definitions
  #define FCLsz_TEXT 20
  MX_CHAR FCL_TEXT[FCLsz_TEXT] = "";
  ...
  FCD_0a401_DisplayManager1__SetTextLabel(29, FCL_TEXT, FCLsz_TEXT, 0, 1, 1, 1);
...
/*=----------------------------------------------------------------------=*\
   Use :Draws a string onto an object or Widget location.
       ...
       :  Text[20] : Text string to set as the label
\*=----------------------------------------------------------------------=*/
void FCD_05fa6_ButtonID3__SetTextLabel(MX_CHAR *FCL_TEXT, MX_UINT16 FCLsz_TEXT)
{
...
/*=----------------------------------------------------------------------=*\
   Use :Draws an integer numerical value with optional units onto an object or Widget location.
       ...
       :  Unit[20] : Unit string to add after the numeric value. e.g. "g" or "s"
\*=----------------------------------------------------------------------=*/
void FCD_05fa6_ButtonID3__SetTextNumber(MX_SINT16 FCL_NUMBER, MX_CHAR *FCL_UNIT, MX_UINT16 FCLsz_UNIT)
{
  //Local variable definitions
  #define FCLsz_TEXT 20
  MX_CHAR FCL_TEXT[FCLsz_TEXT] = "";
...
/*=----------------------------------------------------------------------=*\
   Use :Moves an existing object or Widget to absolute coordinates on the screen.
       ...
       :  Relative : 0=Absolute Positioning, 1=Relative Positioning
\*=----------------------------------------------------------------------=*/
void FCD_05fa6_ButtonID3__ModifyPosition(MX_SINT16 FCL_X, MX_SINT16 FCL_Y, MX_BOOL FCL_RELATIVE)
{

  FCD_0a401_DisplayManager1__ModifyPosition(29, FCL_X, FCL_Y, FCL_RELATIVE);

}

#define FCA_BUTTONID2 0x5fa5
#define FCV_BUTTONID2 0x2299
...
/*=----------------------------------------------------------------------=*\
   Use :Changes the theme index of the selected Object or Widget.
       ...
       :  Redraw : MX_BOOL
\*=----------------------------------------------------------------------=*/
void FCD_05fa5_ButtonID2__ModifyColour(MX_UINT8 FCL_INDEX, MX_UINT8 FCL_R, MX_UINT8 FCL_G, MX_UINT8 FCL_B, MX_BOOL FCL_REDRAW)
{

  FCD_0a401_DisplayManager1__ModifyColour(28, FCL_INDEX, FCL_R, FCL_G, FCL_B, FCL_REDRAW);
...
/*=----------------------------------------------------------------------=*\
   Use :Returns the assigned object/widget ID.
       ...
       :Returns : MX_UINT16
\*=----------------------------------------------------------------------=*/
MX_UINT16 FCD_05fa5_ButtonID2__GetID()
{
  //Local variable definitions
  MX_UINT16 FCR_RETVAL;
...
/*=----------------------------------------------------------------------=*\
   Use :Changes the width and height of the selected Object or Widget.
       ...
       :  Height : MX_UINT16
\*=----------------------------------------------------------------------=*/
void FCD_05fa5_ButtonID2__ModifyScale(MX_UINT16 FCL_WIDTH, MX_UINT16 FCL_HEIGHT)
{

  FCD_0a401_DisplayManager1__ModifyScale(28, FCL_WIDTH, FCL_HEIGHT);
...
/*=----------------------------------------------------------------------=*\
   Use :Draws a floating point value with optional units onto an object or Widget location.
       ...
       :  Unit[20] : Optional unit string to add after the numeric value. e.g. "g" or "s"
\*=----------------------------------------------------------------------=*/
void FCD_05fa5_ButtonID2__SetTextFloat(MX_FLOAT FCL_NUMBER, MX_UINT8 FCL_NUMDP, MX_CHAR *FCL_UNIT, MX_UINT16 FCLsz_UNIT)
{
  //Local variable definitions
  #define FCLsz_TEXT 20
  MX_CHAR FCL_TEXT[FCLsz_TEXT] = "";
  ...
  FCD_0a401_DisplayManager1__SetTextLabel(28, FCL_TEXT, FCLsz_TEXT, 0, 1, 1, 1);
...
/*=----------------------------------------------------------------------=*\
   Use :Draws a string onto an object or Widget location.
       ...
       :  Text[20] : Text string to set as the label
\*=----------------------------------------------------------------------=*/
void FCD_05fa5_ButtonID2__SetTextLabel(MX_CHAR *FCL_TEXT, MX_UINT16 FCLsz_TEXT)
{
...
/*=----------------------------------------------------------------------=*\
   Use :Draws an integer numerical value with optional units onto an object or Widget location.
       ...
       :  Unit[20] : Unit string to add after the numeric value. e.g. "g" or "s"
\*=----------------------------------------------------------------------=*/
void FCD_05fa5_ButtonID2__SetTextNumber(MX_SINT16 FCL_NUMBER, MX_CHAR *FCL_UNIT, MX_UINT16 FCLsz_UNIT)
{
  //Local variable definitions
  #define FCLsz_TEXT 20
  MX_CHAR FCL_TEXT[FCLsz_TEXT] = "";
...
/*=----------------------------------------------------------------------=*\
   Use :Moves an existing object or Widget to absolute coordinates on the screen.
       ...
       :  Relative : 0=Absolute Positioning, 1=Relative Positioning
\*=----------------------------------------------------------------------=*/
void FCD_05fa5_ButtonID2__ModifyPosition(MX_SINT16 FCL_X, MX_SINT16 FCL_Y, MX_BOOL FCL_RELATIVE)
{

  FCD_0a401_DisplayManager1__ModifyPosition(28, FCL_X, FCL_Y, FCL_RELATIVE);

}

#define FCA_BUTTONID1 0x5fa4
#define FCV_BUTTONID1 0x228b
...
/*=----------------------------------------------------------------------=*\
   Use :Changes the theme index of the selected Object or Widget.
       ...
       :  Redraw : MX_BOOL
\*=----------------------------------------------------------------------=*/
void FCD_05fa4_ButtonID1__ModifyColour(MX_UINT8 FCL_INDEX, MX_UINT8 FCL_R, MX_UINT8 FCL_G, MX_UINT8 FCL_B, MX_BOOL FCL_REDRAW)
{

  FCD_0a401_DisplayManager1__ModifyColour(27, FCL_INDEX, FCL_R, FCL_G, FCL_B, FCL_REDRAW);
...
/*=----------------------------------------------------------------------=*\
   Use :Returns the assigned object/widget ID.
       ...
       :Returns : MX_UINT16
\*=----------------------------------------------------------------------=*/
MX_UINT16 FCD_05fa4_ButtonID1__GetID()
{
  //Local variable definitions
  MX_UINT16 FCR_RETVAL;
...
/*=----------------------------------------------------------------------=*\
   Use :Changes the width and height of the selected Object or Widget.
       ...
       :  Height : MX_UINT16
\*=----------------------------------------------------------------------=*/
void FCD_05fa4_ButtonID1__ModifyScale(MX_UINT16 FCL_WIDTH, MX_UINT16 FCL_HEIGHT)
{

  FCD_0a401_DisplayManager1__ModifyScale(27, FCL_WIDTH, FCL_HEIGHT);
...
/*=----------------------------------------------------------------------=*\
   Use :Draws a floating point value with optional units onto an object or Widget location.
       ...
       :  Unit[20] : Optional unit string to add after the numeric value. e.g. "g" or "s"
\*=----------------------------------------------------------------------=*/
void FCD_05fa4_ButtonID1__SetTextFloat(MX_FLOAT FCL_NUMBER, MX_UINT8 FCL_NUMDP, MX_CHAR *FCL_UNIT, MX_UINT16 FCLsz_UNIT)
{
  //Local variable definitions
  #define FCLsz_TEXT 20
  MX_CHAR FCL_TEXT[FCLsz_TEXT] = "";
  ...
  FCD_0a401_DisplayManager1__SetTextLabel(27, FCL_TEXT, FCLsz_TEXT, 0, 1, 1, 1);
...
/*=----------------------------------------------------------------------=*\
   Use :Draws a string onto an object or Widget location.
       ...
       :  Text[20] : Text string to set as the label
\*=----------------------------------------------------------------------=*/
void FCD_05fa4_ButtonID1__SetTextLabel(MX_CHAR *FCL_TEXT, MX_UINT16 FCLsz_TEXT)
{
...
/*=----------------------------------------------------------------------=*\
   Use :Draws an integer numerical value with optional units onto an object or Widget location.
       ...
       :  Unit[20] : Unit string to add after the numeric value. e.g. "g" or "s"
\*=----------------------------------------------------------------------=*/
void FCD_05fa4_ButtonID1__SetTextNumber(MX_SINT16 FCL_NUMBER, MX_CHAR *FCL_UNIT, MX_UINT16 FCLsz_UNIT)
{
  //Local variable definitions
  #define FCLsz_TEXT 20
  MX_CHAR FCL_TEXT[FCLsz_TEXT] = "";
...
/*=----------------------------------------------------------------------=*\
   Use :Moves an existing object or Widget to absolute coordinates on the screen.
       ...
       :  Relative : 0=Absolute Positioning, 1=Relative Positioning
\*=----------------------------------------------------------------------=*/
void FCD_05fa4_ButtonID1__ModifyPosition(MX_SINT16 FCL_X, MX_SINT16 FCL_Y, MX_BOOL FCL_RELATIVE)
{

  FCD_0a401_DisplayManager1__ModifyPosition(27, FCL_X, FCL_Y, FCL_RELATIVE);
...
#define FCV_00731_ST3215__ST3215_ADDR_CUSTOMENDTOOL (0x3)
...
/*=----------------------------------------------------------------------=*\
   Use :Read current RA3 tool mode. 
       :Returns: 0=unassigned, 1=vacuum, 2=gripper, 3=pen
       :
       :Parameters for macro ReadToolMode:
       :  ServoID : Servo ID
       :
       :Returns : Mode value, or 255 if error
\*=----------------------------------------------------------------------=*/
MX_UINT8 FCD_00731_ST3215__ReadToolMode(MX_UINT8 FCL_SERVOID)
{
  //Local variable definitions
  MX_UINT8 FCR_RETVAL; // Mode value, or 255 if error


  FCV_00731_ST3215__PACKETBUFFER[0] = FCV_00731_ST3215__ST3215_ADDR_CUSTOMENDTOOL;
  FCV_00731_ST3215__PACKETBUFFER[1] = 1;
...
/*=----------------------------------------------------------------------=*\
   Use :Set RA3 specific tool mode.
       :Mode: 0=unassigned, 1=vacuum, 2=gripper, 3=pen
       :
       :Parameters for macro SetToolMode:
       :  ServoID : Servo ID
       :  Mode : Mode: 0=unassigned, 1=vacuum, 2=gripper, 3=pen
       :
       :Returns : True if successful
\*=----------------------------------------------------------------------=*/
MX_BOOL FCD_00731_ST3215__SetToolMode(MX_UINT8 FCL_SERVOID, MX_UINT8 FCL_MODE)
{
  //Local variable definitions
  MX_BOOL FCR_RETVAL; // True if successful
...
#define FCV_BUTTONDETECT 0x1f6d
#define FCA_TITLETEXT 0x5fa1
#define FCV_TITLETEXT 0x1f51
...
#define FCV_DISPLAYMANAGER1 0x19e5

/*========================================================================*\
   Use :DisplayManager1
       :GUID: cbfb3c21-f13d-488d-9b90-400c8d4fc605
       :Location: D:\Dev\Flowcode V11\Components\release\DisplayManager.fcpx
       :Version: 37.0 (0x1800028)*
       :Timestamp: 15\04\2026
       :Variable declarations
       :Macro implementations
\*========================================================================*/
#define FCVsz_0a401_DisplayManager1__H 50
#define FCVsz_0a401_DisplayManager1__WIDGETCOLOUR 25
#define FCVsz_0a401_DisplayManager1__WIDGETCOLOUR_1 4
#define FCVsz_0a401_DisplayManager1__WIDGETCOLOUR_2 3
#define FCVsz_0a401_DisplayManager1__VALUE 25
#define FCVsz_0a401_DisplayManager1__BITMAPFILENAME 20
#define FCVsz_0a401_DisplayManager1__OLDVALUE 25
#define FCVsz_0a401_DisplayManager1__OBJECTCOLOUR 25
#define FCVsz_0a401_DisplayManager1__OBJECTCOLOUR_1 3
#define FCVsz_0a401_DisplayManager1__OBJECTCOLOUR_2 3
#define FCVsz_0a401_DisplayManager1__WIDGETHANDLES 25
#define FCVsz_0a401_DisplayManager1__Y 50
#define FCVsz_0a401_DisplayManager1__X 50
#define FCVsz_0a401_DisplayManager1__TYPE 50
#define FCVsz_0a401_DisplayManager1__W 50
#define FCVsz_0a401_DisplayManager1__DRAWHIGHLIGHT 25
#define FCVsz_0a401_DisplayManager1__LINEWIDTH 50
    ...
    {    
      ...
      while (FCL_IDX < FCL_COUNT)
      {
        ...
        {        
          ...
          if (FCV_0a401_DisplayManager1__NUMWIDGETS < 25)
          {          
...
MX_UINT16 FCD_0a401_DisplayManager1__CreateWidget(MX_UINT8 FCL_WIDGETTYPE, MX_UINT16 FCL_X, MX_UINT16 FCL_Y, MX_UINT16 FCL_WIDTH, MX_UINT16 FCL_HEIGHT, MX_UINT8 FCL_LINEWIDTH, MX_UINT8 *FCL_COLOURS, MX_UINT16 FCLsz_COLOURS, MX_UINT8 FCL_DRAWHIGHLIGHT, MX_BOOL FCL_DRAWWIDGET)
{
  ...
  {  
    ...
    FCV_0a401_DisplayManager1__TYPE[25 + FCV_0a401_DisplayManager1__NUMWIDGETS] = FCL_WIDGETTYPE;
    FCV_0a401_DisplayManager1__X[25 + FCV_0a401_DisplayManager1__NUMWIDGETS] = FCL_X;
    FCV_0a401_DisplayManager1__Y[25 + FCV_0a401_DisplayManager1__NUMWIDGETS] = FCL_Y;
    FCV_0a401_DisplayManager1__W[25 + FCV_0a401_DisplayManager1__NUMWIDGETS] = FCL_WIDTH;
    FCV_0a401_DisplayManager1__H[25 + FCV_0a401_DisplayManager1__NUMWIDGETS] = FCL_HEIGHT;
    FCV_0a401_DisplayManager1__LINEWIDTH[25 + FCV_0a401_DisplayManager1__NUMWIDGETS] = FCL_LINEWIDTH;
    ...
    FCR_RETVAL = 25 + FCV_0a401_DisplayManager1__NUMWIDGETS;
...
void FCD_0a401_DisplayManager1__ModifyColour(MX_UINT16 FCL_ID, MX_UINT8 FCL_INDEX, MX_UINT8 FCL_R, MX_UINT8 FCL_G, MX_UINT8 FCL_B, MX_BOOL FCL_REDRAW)
{
  ...
  {  
    ...
    if ((FCL_ID >= 25) && (FCL_ID < (25 + FCV_0a401_DisplayManager1__NUMWIDGETS)))
    {    

      if (FCL_INDEX < 4)
      {      

        FCV_0a401_DisplayManager1__WIDGETCOLOUR[FCL_ID - 25][FCL_INDEX][0] = FCL_R;
        FCV_0a401_DisplayManager1__WIDGETCOLOUR[FCL_ID - 25][FCL_INDEX][1] = FCL_G;
        FCV_0a401_DisplayManager1__WIDGETCOLOUR[FCL_ID - 25][FCL_INDEX][2] = FCL_B;
...
MX_FLOAT FCD_0a401_DisplayManager1__GetSliderValue(MX_UINT16 FCL_WIDGETID)
{
  ...
  {  
    ...
    if ((FCL_WIDGETID >= 25) && (FCL_WIDGETID < (25 + FCV_0a401_DisplayManager1__NUMWIDGETS)))
    {    

      FCR_RETVAL = FCV_0a401_DisplayManager1__VALUE[FCL_WIDGETID - 25];
    ...
    {    
      ...
      {      
        ...
        {        
          ...
          FCL_COORD = FCL_Y - FCV_0a401_DisplayManager1__Y[FCL_ID] - (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1);

          FCL_FVAL = flt_div(flt_fromi(FCL_COORD), flt_fromi((FCV_0a401_DisplayManager1__H[FCL_ID] - FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25])));
        ...
        {        
          ...
          FCL_COORD = FCL_X - FCV_0a401_DisplayManager1__X[FCL_ID] - (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1);

          FCL_FVAL = flt_div(flt_fromi(FCL_COORD), flt_fromi((FCV_0a401_DisplayManager1__W[FCL_ID] - FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25])));
      ...
      //Code has been optimised out by the pre-processor
        ...
        {        
            ...
            {            
              ...
              #if (1) // 3 > 2
                if (FCV_0a401_DisplayManager1__SCENEIDX == 2)
                {                

                                    DC_CB_Func2[FCL_ID](FCL_WHANDLE);
...
void FCD_0a401_DisplayManager1__DrawItem(MX_UINT16 FCL_ID)
{
  ...
  {  
    ...
    #if (1) // 0 == 0
      FCD_029f1_gLCD_EB3__SetForegroundColour(FCV_0a401_DisplayManager1__WIDGETCOLOUR[(FCL_ID - 25)][0][0], FCV_0a401_DisplayManager1__WIDGETCOLOUR[(FCL_ID - 25)][0][1], FCV_0a401_DisplayManager1__WIDGETCOLOUR[(FCL_ID - 25)][0][2]);

      FCD_029f1_gLCD_EB3__SetBackgroundColour(FCV_0a401_DisplayManager1__WIDGETCOLOUR[(FCL_ID - 25)][1][0], FCV_0a401_DisplayManager1__WIDGETCOLOUR[(FCL_ID - 25)][1][1], FCV_0a401_DisplayManager1__WIDGETCOLOUR[(FCL_ID - 25)][1][2]);
    ...
    {    
      ...
      {      
        ...
        #if (1) // 0 == 0
          FCD_029f1_gLCD_EB3__SetForegroundColour(FCV_0a401_DisplayManager1__WIDGETCOLOUR[FCL_ID - 25][1][0], FCV_0a401_DisplayManager1__WIDGETCOLOUR[FCL_ID - 25][1][1], FCV_0a401_DisplayManager1__WIDGETCOLOUR[FCL_ID - 25][1][2]);
      ...
      if (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25])
      {      

        #if (1) // 0 == 0
          FCD_029f1_gLCD_EB3__SetForegroundColour(FCV_0a401_DisplayManager1__WIDGETCOLOUR[(FCL_ID - 25)][3][0], FCV_0a401_DisplayManager1__WIDGETCOLOUR[(FCL_ID - 25)][3][1], FCV_0a401_DisplayManager1__WIDGETCOLOUR[(FCL_ID - 25)][3][2]);
    ...
    {    
      ...
      if (!flt_eq(FCV_0a401_DisplayManager1__VALUE[FCL_ID - 25], FCV_0a401_DisplayManager1__OLDVALUE[FCL_ID - 25]))
      {      

        FCL_PIXELHEIGHT = flt_toi(flt_mul(flt_fromi((FCV_0a401_DisplayManager1__H[FCL_ID] - FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25])), (flt_sub(1.0, FCV_0a401_DisplayManager1__VALUE[FCL_ID - 25]))));

        FCL_PIXELWIDTH = flt_toi(flt_mul(flt_fromi((FCV_0a401_DisplayManager1__H[FCL_ID] - FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25])), (flt_sub(1.0, FCV_0a401_DisplayManager1__OLDVALUE[FCL_ID - 25]))));
          ...
          if (flt_gt(FCV_0a401_DisplayManager1__OLDVALUE[FCL_ID - 25], 1.0))
          {          
            ...
            FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID], FCV_0a401_DisplayManager1__Y[FCL_ID] + FCL_PIXELHEIGHT, FCV_0a401_DisplayManager1__X[FCL_ID] + FCV_0a401_DisplayManager1__W[FCL_ID], ((FCV_0a401_DisplayManager1__Y[FCL_ID] + FCL_PIXELHEIGHT) + FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25]), 0, 1);
            ...
            if (FCL_DIFFERENCE >= FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25])
            {            

              //Comment:
              //Full Thumb Clear and Redraw

              FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID], FCV_0a401_DisplayManager1__Y[FCL_ID] + FCL_PIXELWIDTH, FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1) - (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), ((FCV_0a401_DisplayManager1__Y[FCL_ID] + FCL_PIXELWIDTH) + FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25]), 0, 1);

              FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1) + (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + FCL_PIXELWIDTH, FCV_0a401_DisplayManager1__X[FCL_ID] + FCV_0a401_DisplayManager1__W[FCL_ID], ((FCV_0a401_DisplayManager1__Y[FCL_ID] + FCL_PIXELWIDTH) + FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25]), 0, 1);
              ...
              {              
                ...
                FCD_029f1_gLCD_EB3__SetForegroundColour(FCV_0a401_DisplayManager1__WIDGETCOLOUR[(FCL_ID - 25)][2][0], FCV_0a401_DisplayManager1__WIDGETCOLOUR[(FCL_ID - 25)][2][1], FCV_0a401_DisplayManager1__WIDGETCOLOUR[(FCL_ID - 25)][2][2]);

                FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1) - (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), ((FCV_0a401_DisplayManager1__Y[FCL_ID] + FCL_PIXELHEIGHT) + FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25]), FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1) + (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + FCV_0a401_DisplayManager1__H[FCL_ID], 0, 1);
              ...
              {              
                ...
                FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID], FCV_0a401_DisplayManager1__Y[FCL_ID] + FCL_PIXELWIDTH + FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25], FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1) - (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + FCL_PIXELWIDTH + FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] - FCL_DIFFERENCE, 0, 1);

                FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1) + (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + FCL_PIXELWIDTH + FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] - FCL_DIFFERENCE, FCV_0a401_DisplayManager1__X[FCL_ID] + FCV_0a401_DisplayManager1__W[FCL_ID], FCV_0a401_DisplayManager1__Y[FCL_ID] + FCL_PIXELWIDTH + FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25], 0, 1);
        ...
        FCV_0a401_DisplayManager1__OLDVALUE[FCL_ID - 25] = FCV_0a401_DisplayManager1__VALUE[FCL_ID - 25];
    ...
    {    
      ...
      {      
        ...
        FCL_PIXELWIDTH = flt_toi(flt_mul(flt_fromi((FCV_0a401_DisplayManager1__W[FCL_ID] - FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25])), FCV_0a401_DisplayManager1__VALUE[FCL_ID - 25]));

        FCL_PIXELHEIGHT = flt_toi(flt_mul(flt_fromi((FCV_0a401_DisplayManager1__W[FCL_ID] - FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25])), FCV_0a401_DisplayManager1__OLDVALUE[FCL_ID - 25]));
          ...
          {          
            ...
            FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID] + FCL_PIXELWIDTH, FCV_0a401_DisplayManager1__Y[FCL_ID], FCV_0a401_DisplayManager1__X[FCL_ID] + FCL_PIXELWIDTH + FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25], FCV_0a401_DisplayManager1__Y[FCL_ID] + FCV_0a401_DisplayManager1__H[FCL_ID], 0, 1);
            ...
            {            
              ...
              {              
                ...
                FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID] + FCL_PIXELWIDTH + FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25], FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1) - (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), FCV_0a401_DisplayManager1__X[FCL_ID] + FCV_0a401_DisplayManager1__W[FCL_ID], FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1) + (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), 0, 1);
              ...
              {              
                ...
                FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID] + FCL_PIXELWIDTH + (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] - FCL_DIFFERENCE), FCV_0a401_DisplayManager1__Y[FCL_ID], FCV_0a401_DisplayManager1__X[FCL_ID] + FCL_PIXELWIDTH + FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25], FCV_0a401_DisplayManager1__Y[FCL_ID] + FCV_0a401_DisplayManager1__H[FCL_ID], 0, 1);
                ...
                FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID] + FCL_PIXELHEIGHT + FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25], FCV_0a401_DisplayManager1__Y[FCL_ID], FCV_0a401_DisplayManager1__X[FCL_ID] + FCL_PIXELHEIGHT + FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] - FCL_DIFFERENCE, FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1) - (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), 0, 1);
    ...
    {    
      ...
      {      
        ...
        FCL_PIXELWIDTH = flt_toi(flt_mul(flt_fromi((FCV_0a401_DisplayManager1__H[FCL_ID] - FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25])), flt_sub(1.0, FCV_0a401_DisplayManager1__VALUE[FCL_ID - 25])));

        FCL_PIXELHEIGHT = flt_toi(flt_mul(flt_fromi((FCV_0a401_DisplayManager1__H[FCL_ID] - FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25])), flt_sub(1.0, FCV_0a401_DisplayManager1__OLDVALUE[FCL_ID - 25])));
          ...
          {          
            ...
            FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID], FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), FCV_0a401_DisplayManager1__X[FCL_ID] + FCV_0a401_DisplayManager1__W[FCL_ID], FCV_0a401_DisplayManager1__Y[FCL_ID] + FCV_0a401_DisplayManager1__H[FCL_ID] - (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), 0, 1);

            FCD_029f1_gLCD_EB3__DrawEllipse(FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + FCV_0a401_DisplayManager1__H[FCL_ID] - (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), FCV_0a401_DisplayManager1__W[FCL_ID] >> 1, (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), 0, 1);

            FCD_029f1_gLCD_EB3__DrawEllipse(FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), FCV_0a401_DisplayManager1__W[FCL_ID] >> 1, (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), 0, 1);
            ...
            FCD_029f1_gLCD_EB3__DrawEllipse(FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1) + FCL_PIXELHEIGHT, (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1), FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1, 0, 1);
            ...
            {            
              ...
              FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1) - (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1), FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1) + (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + FCL_PIXELWIDTH + (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), 0, 1);
              ...
              FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1) - (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + FCL_PIXELWIDTH + (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1) + (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + FCV_0a401_DisplayManager1__H[FCL_ID] - (FCV_0a401_DisplayManager1__W[FCL_ID] >> 1), 0, 1);
      ...
      {      
        ...
        FCL_PIXELHEIGHT = flt_toi(flt_mul(flt_fromi((FCV_0a401_DisplayManager1__W[FCL_ID] - FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25])), FCV_0a401_DisplayManager1__OLDVALUE[FCL_ID - 25]));
          ...
          {          
            ...
            FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID], FCV_0a401_DisplayManager1__X[FCL_ID] + FCV_0a401_DisplayManager1__W[FCL_ID] - (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + FCV_0a401_DisplayManager1__H[FCL_ID], 0, 1);

            FCD_029f1_gLCD_EB3__DrawEllipse(FCV_0a401_DisplayManager1__X[FCL_ID] + FCV_0a401_DisplayManager1__W[FCL_ID] - (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1), (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), FCV_0a401_DisplayManager1__H[FCL_ID] >> 1, 0, 1);

            FCD_029f1_gLCD_EB3__DrawEllipse(FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1), (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), FCV_0a401_DisplayManager1__H[FCL_ID] >> 1, 0, 1);
            ...
            FCD_029f1_gLCD_EB3__DrawEllipse(FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1) + FCL_PIXELWIDTH, FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1), FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1, (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1), 0, 1);
            ...
            FCD_029f1_gLCD_EB3__DrawEllipse(FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1) + FCL_PIXELHEIGHT, FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1), FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1, (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1), 0, 1);
            ...
            {            
              ...
              FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID] + (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1) - (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), FCV_0a401_DisplayManager1__X[FCL_ID] + FCL_PIXELWIDTH + (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1) + (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), 0, 1);
              ...
              FCD_029f1_gLCD_EB3__DrawRectangle(FCV_0a401_DisplayManager1__X[FCL_ID] + FCL_PIXELWIDTH + (FCV_0a401_DisplayManager1__DRAWHIGHLIGHT[FCL_ID - 25] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1) - (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), FCV_0a401_DisplayManager1__X[FCL_ID] + FCV_0a401_DisplayManager1__W[FCL_ID] - (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1), FCV_0a401_DisplayManager1__Y[FCL_ID] + (FCV_0a401_DisplayManager1__H[FCL_ID] >> 1) + (FCV_0a401_DisplayManager1__LINEWIDTH[FCL_ID] >> 1), 0, 1);
    ...
    {    
      ...
      #if (1)
        FCD_029f1_gLCD_EB3__SetBitmapTransparency(FCV_0a401_DisplayManager1__WIDGETCOLOUR[FCL_ID - 25][1][0], FCV_0a401_DisplayManager1__WIDGETCOLOUR[FCL_ID - 25][1][1], FCV_0a401_DisplayManager1__WIDGETCOLOUR[FCL_ID - 25][1][2]);

        if (FCV_0a401_DisplayManager1__WIDGETCOLOUR[(FCL_ID - 25)][0][0])
        {        

          FCD_029f1_gLCD_EB3__DrawBitmapScaled(FCV_0a401_DisplayManager1__BITMAPFILENAME, FCVsz_0a401_DisplayManager1__BITMAPFILENAME, FCV_0a401_DisplayManager1__X[FCL_ID], FCV_0a401_DisplayManager1__Y[FCL_ID], FCV_0a401_DisplayManager1__W[FCL_ID], FCV_0a401_DisplayManager1__H[FCL_ID], 0, FCV_0a401_DisplayManager1__WIDGETCOLOUR[FCL_ID - 25][0][1], 0);

        } else {

          FCD_029f1_gLCD_EB3__DrawBitmap(FCV_0a401_DisplayManager1__BITMAPFILENAME, FCVsz_0a401_DisplayManager1__BITMAPFILENAME, FCV_0a401_DisplayManager1__X[FCL_ID], FCV_0a401_DisplayManager1__Y[FCL_ID], 0, FCV_0a401_DisplayManager1__WIDGETCOLOUR[FCL_ID - 25][0][1], 0);
...
void FCD_0a401_DisplayManager1__DrawAll()
{
  ...
  #if (1) // 0 == 0
    FCD_029f1_gLCD_EB3__SetBackgroundColour(9868950, 9868950 >> 8, 9868950 >> 16);
  ...
  {
    FCD_0a401_DisplayManager1__DrawItem(FCL_INDEX + 25);
...
void FCD_0a401_DisplayManager1__SetSliderValue(MX_UINT16 FCL_WIDGETID, MX_FLOAT FCL_VALUE, MX_BOOL FCL_REDRAWSLIDER)
{
  ...
  {  
    ...
    {    
      ...
      FCV_0a401_DisplayManager1__VALUE[FCL_WIDGETID - 25] = FCL_VALUE;
...
void FCD_0a401_DisplayManager1__ModifyBitmap(MX_UINT16 FCL_ID, MX_CHAR *PFCL_FILENAME, MX_BOOL FCL_SCALING, MX_BOOL FCL_TRANSPARANCY, MX_BOOL FCL_REDRAW)
{
  ...
  {  
    ...
    FCV_0a401_DisplayManager1__WIDGETCOLOUR[FCL_ID - 25][0][0] = FCL_SCALING;
    FCV_0a401_DisplayManager1__WIDGETCOLOUR[FCL_ID - 25][0][1] = FCL_TRANSPARANCY;
...
MX_UINT16 FCD_0a401_DisplayManager1__CreateObject(MX_UINT8 FCL_OBJECTTYPE, MX_UINT16 FCL_X, MX_UINT16 FCL_Y, MX_UINT16 FCL_WIDTH, MX_UINT16 FCL_HEIGHT, MX_UINT8 FCL_LINEWIDTH, MX_UINT8 *FCL_COLOURS, MX_UINT16 FCLsz_COLOURS, MX_BOOL FCL_DRAWOBJECT)
{
  ...
  if (FCV_0a401_DisplayManager1__NUMOBJECTS < 25)
  {  
...
MX_GLOBAL MX_UINT8 FCV_SELECTEDIDX = (0x0);
MX_GLOBAL MX_BOOL FCV_HASPOSITION = (0);
MX_GLOBAL MX_BOOL FCV_ISMOVING = (0);
MX_GLOBAL MX_BOOL FCV_RETVAL = (0);
MX_GLOBAL MX_UINT16 FCV_COORDS[FCVsz_COORDS] = {0};
MX_GLOBAL MX_UINT8 FCV_IDS[FCVsz_IDS] = {1,2,3,4,5,6,64};
...
void FCM_SetCenterPoint()
{
  ...
  // Component Macro
  FCL_POSITION = FCD_00731_ST3215__ReadPosition(FCV_IDS[FCV_SELECTEDIDX]);
  ...
  // Component Macro
  FCD_00731_ST3215__DefineMiddle(FCV_IDS[FCV_SELECTEDIDX]);
    ...
    switch (FCL_IDX)
    {
      case 1:
      {
        ...
        {        
          ...
          // Component Macro
          FCD_05fa5_ButtonID2__ModifyColour(3, 0xFF, 0, 0, 1);

        } else {

          // Component Macro
          FCD_05fa5_ButtonID2__ModifyColour(3, 0x5A, 0x5A, 0x5A, 1);

        }

        // Component Macro
        FCD_05fa5_ButtonID2__SetTextLabel("S2", 3);
      ...
      case 2:
      {
        ...
        {        
          ...
          // Component Macro
          FCD_05fa6_ButtonID3__ModifyColour(3, 0xFF, 0, 0, 1);

        } else {

          // Component Macro
          FCD_05fa6_ButtonID3__ModifyColour(3, 0x5A, 0x5A, 0x5A, 1);

        }

        // Component Macro
        FCD_05fa6_ButtonID3__SetTextLabel("S3", 3);
      ...
      case 3:
      {
        ...
        {        
          ...
          // Component Macro
          FCD_05fa7_ButtonID4__ModifyColour(3, 0xFF, 0, 0, 1);

        } else {

          // Component Macro
          FCD_05fa7_ButtonID4__ModifyColour(3, 0x5A, 0x5A, 0x5A, 1);

        }

        // Component Macro
        FCD_05fa7_ButtonID4__SetTextLabel("S4", 3);
      ...
      case 4:
      {
        ...
        {        
          ...
          // Component Macro
          FCD_05fa8_ButtonID5__ModifyColour(3, 0xFF, 0, 0, 1);

        } else {

          // Component Macro
          FCD_05fa8_ButtonID5__ModifyColour(3, 0x5A, 0x5A, 0x5A, 1);

        }

        // Component Macro
        FCD_05fa8_ButtonID5__SetTextLabel("S5", 3);
      ...
      case 5:
      {
        ...
        {        
          ...
          // Component Macro
          FCD_05fa9_ButtonID6__ModifyColour(3, 0xFF, 0, 0, 1);

        } else {

          // Component Macro
          FCD_05fa9_ButtonID6__ModifyColour(3, 0x5A, 0x5A, 0x5A, 1);

        }

        // Component Macro
        FCD_05fa9_ButtonID6__SetTextLabel("S6", 3);
      ...
      default:
      {
        ...
        {        
          ...
          // Component Macro
          FCD_05fa4_ButtonID1__ModifyColour(3, 0xFF, 0, 0, 1);

        } else {

          // Component Macro
          FCD_05fa4_ButtonID1__ModifyColour(3, 0x5A, 0x5A, 0x5A, 1);

        }

        // Component Macro
        FCD_05fa4_ButtonID1__SetTextLabel("S1", 3);
...
void FCM_DetectServos()
{
  ...
  // Component Macro
  FCV_SERVOCOUNT = FCD_00731_ST3215__ListServos(FCV_IDS, 7, 7);
  ...
  {  
    ...
    // Component Macro
    FCV_RETVAL = FCD_00731_ST3215__SetMode(FCV_IDS[FCV_SELECTEDIDX], 0);

    // User Macro
    FCM_AssignActiveServo(FCV_IDS[FCV_SELECTEDIDX]);
...
void FCM_AssignID(MX_UINT8 FCL_NEWID)
{
  ...
  // Component Macro
  FCL_RETVAL = FCD_00731_ST3215__UnlockEEPROM(FCV_IDS[FCV_SELECTEDIDX]);
  ...
  // Component Macro
  FCL_RETVAL = FCD_00731_ST3215__ChangeID(FCV_IDS[FCV_SELECTEDIDX], FCL_NEWID);
  ...
  // Component Macro
  FCL_RETVAL = FCD_00731_ST3215__LockEEPROM(FCL_NEWID);
...
void FCM_ZeroAllServos()
{
  ...
  // Component Macro
  FCD_05fa3_InfoText__SetTextLabel("Moving to mid", 14);

  // Loop
  for (FCL_IDX=0; (FCL_IDX)<(FCV_SERVOCOUNT); (FCL_IDX)++)
  {
    // Component Macro
    FCV_RETVAL = FCD_00731_ST3215__SetSpeed(FCV_IDS[FCV_SELECTEDIDX], 100);

    // Delay
    FCI_DELAYBYTE_MS(10);

    // Component Macro
    FCL_POSITION = FCD_00731_ST3215__SetPosition(FCV_IDS[FCL_IDX], 2048);

    // Delay
    FCI_DELAYBYTE_MS(10);

    // Loop
    while (FCD_00731_ST3215__IsMoving(FCV_IDS[FCL_IDX]))
    {
      // Delay
      FCI_DELAYBYTE_MS(10);
  ...
  // Component Macro
  FCD_05fa3_InfoText__SetTextLabel("Complete", 9);
...
void FCM_MoveServoBy(MX_SINT16 FCL_MOVEMENT)
{
  ...
  // Component Macro
  FCV_RETVAL = FCD_00731_ST3215__StartServo(FCV_IDS[FCV_SELECTEDIDX]);

  // Delay
  FCI_DELAYBYTE_MS(10);

  // Component Macro
  FCV_RETVAL = FCD_00731_ST3215__SetSpeed(FCV_IDS[FCV_SELECTEDIDX], 10);
  ...
  // Component Macro
  FCD_00731_ST3215__SetPosition(FCV_IDS[FCV_SELECTEDIDX], FCL_POSITION);

  // Delay
  FCI_DELAYBYTE_MS(10);

  // Loop
  while (FCD_00731_ST3215__IsMoving(FCV_IDS[FCV_SELECTEDIDX]))
  {
    // Delay
    FCI_DELAYBYTE_MS(10);
...
void FCM_DC_Touched(MX_UINT32 FCL_HANDLE)
{
  ...
  // Decision
  if (FCL_HANDLE == FCV_BUTTONASSIGN7)
  {  
    ...
    // Component Macro
    FCD_05fa3_InfoText__SetTextLabel("Tool Vacuum", 12);

    // Component Macro
    FCD_00731_ST3215__SetToolMode(64, 1);
  ...
  // Decision
  if (FCL_HANDLE == FCV_BUTTONASSIGN8)
  {  
    ...
    // Component Macro
    FCD_05fa3_InfoText__SetTextLabel("Tool Gripper", 13);

    // Component Macro
    FCD_00731_ST3215__SetToolMode(64, 2);
  ...
  // Decision
  if (FCL_HANDLE == FCV_BUTTONASSIGN9)
  {  
    ...
    // Component Macro
    FCD_05fa3_InfoText__SetTextLabel("Tool Pen", 9);

    // Component Macro
    FCD_00731_ST3215__SetToolMode(64, 3);
  ...
  // Decision
  if (FCL_HANDLE == FCV_BUTTONASSIGNCENTER)
  {  
  ...
  // Decision
  if (FCL_HANDLE == FCV_BUTTONZEROALL)
  {  
  ...
  // Decision
  if (FCL_HANDLE == FCV_BUTTONSETID)
  {  

    // User Macro
    FCD_0a401_DisplayManager1__DrawScene(2);
